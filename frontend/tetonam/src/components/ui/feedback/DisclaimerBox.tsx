...
export const DisclaimerBox = ({ className }: DisclaimerBoxProps) => {
  return (
    <div
      className={cn(
        'flex items-start space-x-3 p-4 bg-amber-50 border border-amber-200 rounded-lg shadow-sm',
        className
      )}
      role='alert'
    ...
    >
      ...
      <div className='flex-1'>
        <h3 id='disclaimer-title' className='font-semibold text-amber-800 mb-2'>
          중요 안내
        </h3>
